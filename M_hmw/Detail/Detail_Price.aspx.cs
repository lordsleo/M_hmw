...
{
    public partial class Detail_Price : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlString = string.Format("select topic,source,to_char(POST_TIME,'yyyy-MM-dd HH24:mi:ss') as POST_TIME ,message from news_topic where  classid='{0}' and id = '{1}'", classId, PriceId);
