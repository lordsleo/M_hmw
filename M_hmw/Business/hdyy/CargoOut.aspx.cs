    ...
    public partial class CargoOut : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                sql =
                    string.Format(
                        "select count(code_client) as sum from vw_stockout_web where code_department='{0}' and code_client='{1}' ", companyCode, clientCode);
